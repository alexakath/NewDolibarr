...
const RESOURCE_ONLY_MODULES = ['employees', 'salaries', 'import_history', 'settings']
Object.entries(MODULES).forEach(([key, mod]) => {
  if (RESOURCE_ONLY_MODULES.includes(key)) {
...
app.use('/api/jours-feries', require('./routes/jours_feries'))
